resource "aws_wafv2_web_acl" "alb" {
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.name_prefix}-admin-protection"
      sampled_requests_enabled   = true
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.name_prefix}-rate-limit-payments"
      sampled_requests_enabled   = true
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.name_prefix}-rate-limit-transactions"
      sampled_requests_enabled   = true
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.name_prefix}-rate-limit-ops"
      sampled_requests_enabled   = true
    }
  }
  ...
  rule {
    ...
    visibility_config {
      cloudwatch_metrics_enabled = true
      metric_name                = "${local.name_prefix}-rate-limit-audit"
      sampled_requests_enabled   = true
    }
  }
